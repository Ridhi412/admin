...
// export const CandidateProfileFetchQuery = async () => {
//     db.collection("Candidate_Profile").get().then(function(querySnapshot) {
...
// var docRef = db.collection("Candidate_Profile").doc("aVn5F9D09UXbjX4gwzP9PwTTMVC3");
    ...
    db.collection('cities')
        ...
        .then(function (querySnapshot) {
            querySnapshot.forEach(function (doc) {
                ...
                x = x + '<tr><td>' + doc.data().country + '</td><td>abc</td><td>def</td></tr>';
                dbvalues.push(doc.data());
            });
            console.log(dbvalues);
            // console.log(dbvalues.map);
        });
};
...
const Tables = () => {
    return (
        <React.Fragment>
            ...
            {/* console.log({this.CandidateProfileFetchQuery}); */}
