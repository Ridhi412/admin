...
export const applicationForm1Query = async (cutoffGM, cutoffOthers, cutoffPwD, examDate, resultDate, importedCSV) => {
    try {
        var data = db.collection('Global_Variables').doc('result');
        data.set({
            cutoffGM: cutoffGM,
            cutoffOthers: cutoffOthers,
            cutoffPwD: cutoffPwD,
            examDate: examDate,
...
export const applicationForm2Query = async (isResultAvailable) => {
    try {
        var data = db.collection('Global_Variables').doc('resultAvailable');
...
class GenerateResult extends Component {
    ...
    applicationForm1 = () => {
        applicationForm1Query(
            this.state.cutoffGM,
            this.state.cutoffOthers,
            this.state.cutoffPwD,
            this.state.examDate,
    ...
    applicationForm2 = () => {
        applicationForm2Query(this.state.isResultAvailable);
    };
    ...
    render() {
        return (
            <React.Fragment>
                <h4 className="header-title mt-4">Generate Result</h4>
                ...
                <Row>
                    <Col>
                        <Card>
                            <CardBody>
                                <FormGroup row>
                                    <Label for="fname" md={5}>
                                        Eligibility Criteria for GM Candidates
                                    </Label>
                                    <Col md={7}>
                                        <Row>
                                            <Col>
                                                <MaskedInput
                                                    ...
                                                    value={this.state.cutoffGM}
                                                    onChange={(e) => {
                                                        this.setState({ cutoffGM: e.target.value });
                                ...
                                <FormGroup row>
                                    <Label for="fname" md={5}>
                                        Eligibility Criteria for OBC/SC/ST Candidates
                                    </Label>
                                    <Col md={7}>
                                        <Row>
                                            <Col>
                                                <MaskedInput
                                                    ...
                                                    placeholder="__.__%"
                                                    className="form-control"
                                                    value={this.state.cutoffOthers}
                                                    onChange={(e) => {
                                                        this.setState({ cutoffOthers: e.target.value });
                                                        console.log(e.target.value);
                                                    }}
                                                />
                                            </Col>
                                        ...
                                        <Row>
                                            <Col>
                                                <MaskedInput
                                                    ...
                                                    placeholder="__.__%"
                                                    className="form-control"
                                                    value={this.state.cutoffPwD}
                                                    onChange={(e) => {
                                                        this.setState({ cutoffPwD: e.target.value });
                                                        console.log(e.target.value);
                                                    }}
                                                />
                                            </Col>
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={7}>
                                        <Input
                                            ...
                                            name="resultDate"
                                            id="resultDate"
                                            placeholder="Enter Result Declared Date"
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={7}>
                                        <Input
                                            ...
                                            value={this.state.importedCSV}
                                            onChange={(e) => {
                                                this.setState({ importedCSV: e.target.value });
                                                console.log(e.target.value);
                                            }}
                                        />
                                    </Col>
                                ...
                                <div class="row mt-5 mx-2">
                                    <table className="table table-bordered" style={{ border: '1px solid #000' }}>
                                        <Row>
                                            ...
                                            <Col md={9}>
                                                <h5 className="ml-3">Provide access to Result for all Candidates</h5>
                                            </Col>
                                            <Col md={3}>
                                                <CustomInput
                                                    type="switch"
                                                    ...
                                                    value={this.state.isResultAvailable}
                                                    onChange={(e) => {
                                                        this.setState({
                                                            isResultAvailable: !this.state.isResultAvailable,
                                                        });
                                                        console.log(e.target.value);
                                                        this.sendState();
...
class Result extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <h3 className="header-title mb-3 mt-3">Result</h3>
                <Card>
                    <CardBody>
